...
describe Admin::ForumsController do
  describe "routing" do
    ...
    it "routes to #change_status" do
      put("/admin/forums/1/change_status/active").should route_to("admin/forums#change_status",
    ...
    it "routes to #complaints" do
      get("/admin/forums/1/complaints").should_not route_to("admin/forums#complaints", :id => "1")
    end
  end
end
